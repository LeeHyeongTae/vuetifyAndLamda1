<template>
        <div>
                ...
                <div >
                    <table height="50">
                        <tr>
                            ...
                            <td>
                                <input @keyup.enter="search" id="search" type="text" style="background-repeat: no-repeat;" title="검색">
                            </td>
                            <td>
                                <button @click="search" id="search_btn" type="submit" tabindex="3" class="btn_submit">
            ...
            <table class="table" style="margin: 0 auto; width: 850px; height: 500px">
                <tr>
                    <td rowspan="3" width="45%">
                        <img src="https://upload.wikimedia.org/wikipedia/ko/2/26/%EB%A7%A4%ED%8A%B8%EB%A6%AD%EC%8A%A4_%ED%8F%AC%EC%8A%A4%ED%84%B0.jpg" height="500px" width="100%">
                    </td>
                ...
                <tr>
                    <td style="padding-left: 20px; font-size: 18px" height="18px">
                        <span style="padding-right: 10px; border-right : 1px solid #E4e4e4">예매 : <span style="color:#ff382e">{{ item.rank }}</span>위</span>
                        <span style="padding-left : 10px">기준일 : {{ item.rankDate }}</span>
                    </td>
                </tr>
                <tr>
                    <td height="437px">
...
<script>
    ...
    export default {
        created() {
            // this.$store.dispatch('search/selectOne',{cate:'movies',seq:0})
        },
        computed: {
            ...mapState({
