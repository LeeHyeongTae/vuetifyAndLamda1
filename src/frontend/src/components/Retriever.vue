<template>
    <div>
        ...
        <div class="text-center">
            ...
            <span v-if="pager.existPrev" @click="prevBlock" stlye="width: 50px; height: 50px; border: 1px solid black; margin-right: 5px">이전</span>
            <span v-for="i of pages" :key="i" stlye="width: 50px; height: 50px; border: 1px solid black; margin-right: 5px">{{ i }}</span>
            <span v-if="pager.existNext" @click="nextBlock" stlye="width: 50px; height: 50px; border: 1px solid black; margin-right: 5px">다음</span>
